...
parser = ap.ArgumentParser(description = 'Prune a presence-absence table to include only certain protein clusters. Takes a *.by P-A table and a *.txt list of protein cluster names [PC_*].')

parser.add_argument('t_file', metavar = 'TABLE', type = ap.FileType('r'), help = 'Path to the presence-absence table file.')
