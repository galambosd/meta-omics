...
for module in modules.keys():
    mcr_list = []
    # for every MAG in the MAG list, calculate the mcr and append to a list
    # Make a series and then a dataframe, keep appending to the total dataframe
    for bin in bin_KO:
        # calculate the module completion score
        mcr = MCR(modules[module], bin_KO[bin])
        mcr_list.append(mcr)
    # add it to a running dataframe
...
# plot a heatmap of the results and cluster it according to
